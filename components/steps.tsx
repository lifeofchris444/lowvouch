        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 lg:gap-4">
            {steps.map((step, index) => (
              <div
                key={index}
                className={`group bg-card border border-border/60 rounded-2xl p-4 hover:border-[#004990]/30 transition-all duration-300 hover:shadow-lg hover:shadow-[#004990]/5 hover:-translate-y-1 touch-card ${
              ...
              >
                <div className="flex items-start gap-4">
                  {/* Step number */}
                  <div
                    className={`flex-shrink-0 w-8 h-8 bg-[#004990] text-white rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-500 ${
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="touch-icon w-12 h-12 bg-muted rounded-xl flex items-center justify-center mb-3 group-hover:bg-[#004990]/10 transition-colors duration-300">
                      <step.icon className="w-6 h-6 text-foreground/70 group-hover:text-[#004990] transition-colors duration-300" strokeWidth={1.5} />
                    </div>
