...
import { ArrowRight, Gift, Sparkles, Home } from "lucide-react";
  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-10 pb-14 sm:pt-14 sm:pb-18 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#004990] rounded-3xl p-7 sm:p-10 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="absolute bottom-12 left-16 opacity-20 animate-float" style={{ animationDelay: "1s" }}>
            <div className="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center rotate-6">
              <Home className="w-7 h-7 text-white" strokeWidth={1.5} />
            </div>
          </div>
          ...
          <div className="relative z-10">
            ...
            >
              Join thousands of homeowners who have already claimed their $750 reward. Your next project is just a few clicks away.
            </p>
            ...
            >
              <a
                ...
                className="touch-button group inline-flex items-center gap-3 bg-white text-[#004990] px-10 py-5 rounded-full text-lg font-semibold hover:bg-white/95 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
              >
                APPLY NOW
