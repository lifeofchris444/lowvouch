...
const AFFILIATE_LINK = "https://trksy.org/aff_c?offer_id=3615&aff_id=26188"

const BLUE = "#003A73"
const BLUE_DEEP = "#001F42"
const BLUE_BRIGHT = "#1A5CA0"
const INK = "#111213"
...
const CATEGORIES = [
  {
    t: "Tools & Hardware",
    d: "Drills, tool sets, and storage.",
    icon: "M14.7 6.3a4 4 0 00-5.4 5.4L4 17l3 3 5.3-5.3a4 4 0 005.4-5.4l-2.6 2.6-2.4-.6-.6-2.4 2.6-2.6z",
  },
  {
    t: "Lawn & Garden",
    d: "Garden tools, planters, and grill gear.",
    icon: "M5 19c8 0 14-6 14-14-8 0-14 6-14 14z M5 19c0-5 3-9 7-11",
  },
  {
    t: "Paint & Refresh",
    d: "Paint, rugs, and shelving.",
    icon: "M4 4h12v4H4z M16 5h4v4h-4 M18 9v3h-7v3 M10 15h2v5h-2z",
  },
  {
    t: "Smart Home & Fixtures",
    d: "Thermostats, lighting, and faucets.",
    icon: "M4 11l8-7 8 7 M6 9.5V20h12V9.5 M12 11l-1.5 3.5h3L12 18",
  },
]
  ...
  return (
    <div className="relative grid grid-cols-[3rem_1fr] md:grid-cols-[1fr_3.5rem_1fr] gap-x-4 md:gap-x-8 items-center pb-6 md:pb-8 last:pb-0">
      <div
        ...
        aria-hidden="true"
      >
        <span className="font-black text-6xl lg:text-7xl leading-none select-none" style={{ color: "#E6EEF6" }}>
          0{index + 1}
        </span>
      </div>
      ...
      <div className="order-1 md:order-2 flex justify-center self-start md:self-center pt-1 md:pt-0">
        <div
          ...
          style={{
            ...
            borderColor: BLUE,
            color: "#FFFFFF",
            boxShadow: "0 8px 22px rgba(0,58,115,.35)",
          }}
        >
          {index + 1}
        </div>
...
export default function LowesRewardLander() {
  ...
  return (
    <div className="min-h-screen bg-white antialiased overflow-x-hidden font-sans" style={{ color: INK }}>
      <style>{`
        ...
        .card-shine { position: absolute; inset: 0; pointer-events: none; background: linear-gradient(115deg, transparent 35%, rgba(0,58,115,0.05) 47%, rgba(255,255,255,0.55) 52%, transparent 65%); background-size: 260% 100%; animation: cardShine 7s ease-in-out infinite; }
        ...
        .cat-spark { position: absolute; top: 16px; right: 18px; color: #003A73; animation: sparkTwinkle 3.4s ease-in-out infinite; }
        ...
        .t-card:hover { transform: translateY(-6px); border-color: rgba(0,58,115,.35); box-shadow: 0 18px 44px rgba(0,58,115,.12); }
        .t-rail-fill { background: linear-gradient(180deg, #1A5CA0, #003A73); }
      ...
      >
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#3573AC" }} />
        <div
          className="orb w-80 h-80 top-1/3 -right-20"
          style={{ backgroundColor: "#001F42", animationDelay: "-6s" }}
        />
        ...
        <div className="relative mx-auto max-w-3xl px-6 pt-12 pb-20 md:pt-20 md:pb-24 text-center">
          <div className="text-white">
            ...
            <h1 className="mt-6 font-black tracking-tight leading-[1.05] text-[2.15rem] sm:text-5xl md:text-6xl lg:text-7xl text-balance">
              {"The Lowe's Discounts They Don't Advertise"}
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/85 max-w-xl mx-auto leading-relaxed text-pretty">
              Discover how shoppers are unlocking hidden discount codes on tools, garden gear, paint, and home fixtures.
            </p>
      ...
      >
        ...
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#4C8CC2", opacity: 0.35 }} />
        <div
          className="orb w-80 h-80 -bottom-24 -right-16"
          style={{ backgroundColor: "#001F42", animationDelay: "-5s" }}
        />
