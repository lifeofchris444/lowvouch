      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className={`bg-card border border-border/60 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#004990]/30 touch-card ${
                sectionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
              }`}
              style={{
            ...
            >
              ...
              >
                <div className="touch-icon flex-shrink-0 w-12 h-12 bg-muted rounded-xl flex items-center justify-center group-hover:bg-[#004990]/10 transition-colors duration-200">
                  <faq.icon className="w-6 h-6 text-foreground/70 group-hover:text-[#004990] transition-colors duration-200" strokeWidth={1.5} />
                </div>
                <span className="flex-1 font-semibold text-foreground text-lg">
                  {faq.question}
                </span>
                <div className="touch-icon flex-shrink-0 w-10 h-10 bg-muted rounded-full flex items-center justify-center group-hover:bg-[#004990]/10 transition-colors duration-200">
                  <ChevronDown
                    className={`w-5 h-5 text-foreground/70 group-hover:text-[#004990] transition-all duration-300 ease-out ${
