  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#004990] font-semibold">Lowe&apos;s</span>{" "}
        ...
        >
          Discover how people are saving on tools, home improvement projects, appliances, and everyday essentials.
        </p>
        ...
        >
          <a
            href="https://trksy.org/aff_c?offer_id=3616&aff_id=26188"
            target="_blank"
            rel="noopener noreferrer"
            className="touch-button group inline-flex items-center gap-3 bg-[#004990] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#003a73] transition-all duration-300 hover:shadow-xl hover:shadow-[#004990]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
        ...
        >
          ...
          <p className="text-sm text-muted-foreground/70 font-medium">
            <span className="sm:hidden">Join 12,000+ homeowners who&apos;ve<br />already claimed their rewards.</span>
            <span className="hidden sm:inline">Join 12,000+ homeowners who&apos;ve already claimed their rewards.</span>
          </p>
        </div>
      </div>
    </section>
